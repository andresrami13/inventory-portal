...
export default function CartDrawer({ open, onClose }: Props) {
  ...
  return (
    <>
      ...
      {open && (
        <div
          className="fixed inset-0 bg-black/40 z-20 md:bg-black/30"
          onClick={onClose}
          aria-hidden="true"
        />
      )}
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3 flex flex-col gap-3">
          {items.length === 0 ? (
            ...
            items.map(({ product, quantity }) => (
              <div key={product.id} className="flex gap-3 items-start bg-gray-50 rounded-xl p-3">
                {product.image_url ? (
                  <img
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <button
                      ...
                      className="w-7 h-7 rounded-lg bg-white border border-gray-300 flex items-center justify-center text-gray-700 font-bold active:bg-gray-100"
                ...
                <button
                  ...
                  className="p-1 text-gray-400 hover:text-red-500 active:text-red-600 mt-0.5"
